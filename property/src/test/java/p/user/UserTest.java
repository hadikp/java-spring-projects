...
class UserTest {
    ...
    void init(){
        ...
        Property telek = new Property("Telek leírás", Category.TELEK, 2_000_000, "Fejér", "Székesfehérvár", "Palotai út", 40, false, LocalDate.of(2023, 7, 12), LocalDate.of(2023, 10, 12), List.of("src/images1", "src/images2", "src/images3"));
